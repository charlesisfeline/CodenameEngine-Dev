...
class Stage extends DisplayObjectContainer #if lime implements IModule #end
{
	...
	**/
	...
	// Ne_Eo added this
	public var lastRenderStart:Float = 0;
	public var lastRenderEnd:Float = 0;
	public var openfl_deltaTime:Float = 0;
	...
	@:noCompletion private function __onLimeRender(context:RenderContext):Void
	{
		...
		#if !macro
		var renderStart = funkin.backend.utils.EngineUtil.getTime();
		#end
		...
		#if !macro
		var renderEnd = funkin.backend.utils.EngineUtil.getTime();

		lastRenderStart = renderStart;
		lastRenderEnd = renderEnd;
		openfl_deltaTime = time;
		#end
	...
	public var lastUpdate:Float = 0.0;
	public var latestUpdate:Float = 0.0;

	@:noCompletion private function __onLimeUpdate(deltaTime:Int):Void
	{
		var time = #if !macro funkin.backend.utils.EngineUtil.getTime() #else Lib.getTimer() #end;
		lastUpdate = latestUpdate;
		latestUpdate = time;

		//__deltaTime = latestUpdate - lastUpdate;
