...
class Chart {
	...
	public static function loadChartMeta(songName:String, difficulty:String = null, fromMods:Bool = true) {
		if(difficulty == null)
	...
	public static function parse(songName:String, difficulty:String = null):ChartData {
		if(difficulty == null)
			difficulty = Constants.DEFAULT_DIFFICULTY;
