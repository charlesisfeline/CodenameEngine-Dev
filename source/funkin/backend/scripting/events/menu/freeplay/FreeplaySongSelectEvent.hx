...
final class FreeplaySongSelectEvent extends CancellableEvent {
	...
	@:noCompletion private function set_opponentMode(val:Bool) {
		gameMode = coopMode ? (val ? FreeplayGameMode.getSpecific("codename.coop-opponent") : FreeplayGameMode.getSpecific("codename.opponent")) : (val ? FreeplayGameMode.getSpecific("codename.opponent") : null);
		return val;
	}
	...
	@:noCompletion private function set_coopMode(val:Bool) {
		gameMode = opponentMode ? (val ? FreeplayGameMode.getSpecific("codename.coop-opponent") : FreeplayGameMode.getSpecific("codename.coop")) : (val ? FreeplayGameMode.getSpecific("codename.coop") : null);
		return val;
	}
}